...
This is the closest I've ever seen to a cat passing the mirror test. It's not perfectly conclusive, but very suggestive. I would like to see either more cats do this or 
...
Just because they're *relatively* less visual doesn't mean that they are not primarily visual. Dogs can still recognize other dogs without smell or sound. For example, here's an example of a [dog imitating another dog on TV](https://animalsusingtools.com/pages/electronics/#dog-imitating-dog-on-tv).
